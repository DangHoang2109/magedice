...
/// <summary>
/// Setting : Vibration. IsVibrate bool
/// <para>
/// WARNING! Call Init() when the game just started
/// </para>
/// </summary>
public static class Vibration
{
    private const string KEY_SETTING_VIBRATION = "SETTING_VIBRATION";
    private static bool _isVibrate = true;
    public static bool IsVibrate
    {
        ...
        {
            _isVibrate = value;
            PlayerPrefs.SetInt(KEY_SETTING_VIBRATION, value ? 1 : 0);
        }
    }
    ...
    public static void Init ()
    {
        ...
        _isVibrate = PlayerPrefs.GetInt(KEY_SETTING_VIBRATION, 1) == 1;
    ...
    public static void Vibrate ( long milliseconds )
    {
        ...
        if ( Application.isMobilePlatform ) {
            ...
            if(vibrator == null)
            {
                Debug.LogError("Vibration Vibrate: vibrator has not been initialized!");
                return;
            }
            try
            {
    ...
    public static void Cancel ()
    {
        if ( Application.isMobilePlatform ) {
            ...
            if (vibrator == null)
            {
                Debug.LogError("Vibration Cancel: vibrator has not been initialized!");
                return;
            }
            try
            {
