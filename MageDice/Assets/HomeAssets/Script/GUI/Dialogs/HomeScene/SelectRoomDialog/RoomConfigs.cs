...
public class RoomConfigs : ScriptableObject
{
    ...
    private void ConvertData()
    {
        ...
        //{
        //    r.bagReward.sequenceBagReward = new List<BagType>();
...
public class RoomBagRewardConfig
{
    ...
    //    else
    //    {
    //        int trueIndex = index % sequenceBagReward.Count;
    //        return sequenceBagReward[trueIndex];
    //    }
    //}
