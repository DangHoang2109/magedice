...
public class MainBonusIcon : BaseIcon
{
    ...
    public override void OnClickIcon()
    {
        ...
        GameManager.Instance.OnShowDialogWithSorting<BonusRewardDialog>("Home/GUI/BonusRewardDialog/BonusRewardDialog", PopupSortingType.CenterBottomAndTopBar);
        //if (this.isFree)
        //{
        //    this.OpenFreeBag();
        //}
